...
$routes->get('/details/(:segment)', 'Home::detail/$1');
$routes->get('/similar/(:segment)', 'Home::similar/$1');
$routes->get('/categories/(:segment)', 'Home::categories/$1');
$routes->get('/developers/(:segment)', 'Home::developers/$1');
$routes->get('/search', 'Home::search');
$routes->post('/search', 'Home::search');
$routes->get('/apps', 'Home::apps');
$routes->get('/games', 'Home::games');
$routes->get('/url', 'Home::url');
